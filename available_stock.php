                    ...
                    <div class="pull-right">
                        ...
                        <ul class="pagination">
                            ...
                            if($page_number != 1)
                            {
                                ?>
                            <li class="previous">
                                <a href="available_stock?page=<?php echo $page_number - 1; ?>">Prev</a>
                            </li>
                                <?php
                            }
                            ?>
                            ...
                            <li class="<?php  $i == $page_number ? print 'active' : ''; ?>">
                                <a href="available_stock?page=<?php echo $i; ?>" >
                                    <?php echo $i; ?>
                                </a>
                            </li>
                                <?php
                            ...
                            if($page_number != $page_count)
                            {
                                ?>
                            <li class="next">
                                <a href="available_stock?page=<?php echo $page_number + 1; ?>"> Next</a>
                            </li>
                                <?php
                            }
                            ?>
      ...
      <div class="col-md-12">
          ...
          <div class="col-md-4">
              <a href="#" class="btn btn-success"
                 onclick="window.open('print_available_stock.php', 'printing', 'width=800,height=400')">
