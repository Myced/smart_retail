...
<div class="row">
    ...
    <div class="row">
      ...
      <div class="row">
          <!--search bar-->
          <form action="product_sales_report.php" method="POST">
            <div class="col-md-4">
                <div class="text-center">
              ...
              <div class="table-responsive">
                  <div id="table_area">
                        <table class="table table-striped table-bordered text-center">
                          ...
                          <?php
                          $sales = 0;
                            if (!isset($error) && isset($product) && $product != '--') {
                              while ($sd <= $ed) {
                                  //get the data first
                                  ...
                                  $query = "SELECT * FROM `sales` WHERE "
                                          ...
                                          . " AND `year` = '$yeear' AND `product_code` = '$product'";
                                  $res = mysqli_query($dbc, $query);
                    ...
                    <div class="pull-right">
                        ...
                        <ul class="pagination">
                            ...
                            if($page_number != 1)
                            {
                                ?>
                            <li class="previous">
                                <a href="product_sales_report.php?page=<?php echo $page_number - 1; ?>">Prev</a>
                            </li>
                                <?php
                            }
                            ?>
  ...
  <div class="row">
      <div class="col-md-12">
          ...
          <div class="col-md-4">
              ...
              $url = "print_product_report.php?code=" . $product . "&start_date=" . $s_date . "&end_date=" . $e_date;
              ?>
