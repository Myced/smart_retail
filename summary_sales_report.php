...
//do the query here
$query = "SELECT * FROM `sales_ref` ORDER BY `id` DESC LIMIT $start, $end";
$result = mysqli_query($dbc, $query)
        or die("Error");
...
<div class="row">
    ...
    <div class="row">
          <!--search bar-->
          <form action="summary_sales_report.php" method="POST">
            <div class="col-md-4">
                <div class="text-center">
              ...
              <div class="table-responsive">
                  <div id="table_area">
                        <table class="table table-striped table-bordered text-center white-background table-condensed">
                            ...
                            <th> Client Name</th>
                            <th> Items Sold</th>
                            <th> Total Cost <br> of Items Sold </th>
                            <th> Action </th>
                                          ...
                                          <tr style="background-color:  white;">
                                            ...
                                            <td>
                                                <button class="btn btn-success" 
                                                        onclick="window.open('receipt.php?ref=<?php echo $row['ref']; ?>', '', 'width=800,height=400')">
                    ...
                    <div class="pull-right">
                        ...
                        <ul class="pagination">
                            ...
                            if($page_number != 1)
                            {
                                ?>
                            <li class="previous">
                                <a href="summary_sales_report.php?page=<?php echo $page_number - 1; ?>">Prev</a>
                            </li>
                                <?php
                            }
                            ?>
                            ...
                            <li class="<?php  $i == $page_number ? print 'active' : ''; ?>">
                                <a href="summary_sales_report.php?page=<?php echo $i; ?>" >
                                    <?php echo $i; ?>
                                </a>
                            </li>
                                <?php
                            ...
                            if($page_number != $page_count)
                            {
                                ?>
                            <li class="next">
                                <a href="summary_sales_report.php?page=<?php echo $page_number + 1; ?>"> Next</a>
                            </li>
                                <?php
                            }
                            ?>
