    ...
    <div class="row">
          ...
          <div class="col-md-12">
              <div class="text-center">
                  <h2>Customer Transcation Report </h2>
      ...
      <div class="row">
          <!--search bar-->
          <form action="customer_transaction_report.php" method="POST">
            <div class="col-md-4">
                <div class="text-center">
                    ...
                    <div class="pull-right">
                        ...
                        <ul class="pagination">
                            ...
                            if($page_number != 1)
                            {
                                ?>
                            <li class="previous">
                                <a href="customer_transaction_report.php?page=<?php echo $page_number - 1; ?>">Prev</a>
                            </li>
                                <?php
                            }
                            ?>
                            ...
                            <li class="<?php  $i == $page_number ? print 'active' : ''; ?>">
                                <a href="customer_transaction_report.php?page=<?php echo $i; ?>" >
                                    <?php echo $i; ?>
                                </a>
                            </li>
                                <?php
                            ...
                            if($page_number != $page_count)
                            {
                                ?>
                            <li class="next">
                                <a href="customer_transaction_report.php?page=<?php echo $page_number + 1; ?>"> Next</a>
                            </li>
                                <?php
                            }
                            ?>
