...
//do the query here
$query = "SELECT * FROM `return_ref` ORDER BY `id` DESC LIMIT $start, $end";
$result = mysqli_query($dbc, $query)
        or die("Error");
              ...
              <div class="table-responsive">
                  <div id="table_area">
                        <table class="table table-striped table-bordered text-center white-background">
                            ...
                            <th> Total Cost <br> of Items Returned </th>
                            <th> Action </th>
                              ...
                              <tr style="background-color:  white;">
                                ...
                                <td>
                                    <button class="btn btn-success" 
                                            onclick="window.open('print_returned_inventory.php?ref=<?php echo $row['ref']; ?>', '', 'width=800,height=400')">
