...
<html>
    ...
    <body>
        <div class="container">
            ...
            <?php 
                $query = "SELECT * FROM `stock_update_ref` WHERE `ref` = '$ref'";
...
?>
            ...
            <div class="row">
                ...
                <div class="document_data">
                    <?php
                    $query = "SELECT * FROM `stock_update` WHERE `ref` = '$ref'";
                    $result = mysqli_query($dbc, $query);
                    ?>
                        ...
                        if (mysqli_num_rows($result) == 0) {
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <?php echo $row['product_name']; ?>
                                    ...
                                    <td>
                                <?php echo $row['old_quantity']; ?>
                                    </td>

                                    <td>
                                <?php echo $row['added_quantity']; ?>
                                    </td>
                                    
                                    <td>
                                <?php echo $row['new_quantity']; ?>
                                    </td>
