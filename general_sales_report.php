...
<div class="row">
    ...
    <div class="row">
          <!--search bar-->
          <form action="general_sales_report.php" method="POST">
            <div class="col-md-4">
                <div class="text-center">
  ...
  <div class="row">
      <div class="col-md-12">
          ...
          <div class="col-md-4">
              ...
              if(isset($show_search))
              {
                  $url = "print_period_report.php?start_date=" . $s_date . "&end_date=" . $e_date;
                    ?>
...
<script>
    $(document).on('click', '#all', function(){
        ...
        {
            window.open('print_general_report.php', '', 'width=800,height=400');
        }
    });
</script>
