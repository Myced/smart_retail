...
$query = "SELECT * from `stock_update_ref`";
...
//do the query here
$query = "SELECT * FROM `stock_update_ref` ORDER BY `id` DESC LIMIT $start, $end";
$result = mysqli_query($dbc, $query)
        or die("Error");
...
<div class="row">
    ...
    <div class="row">
        <div class="text-center col-md-12">
            <h2 class="page-header"> Stock Update  Report </h2>
        </div>
    </div>
    <br>
    <div class="row">
                              ...
                              <tr style="background-color:  white;">
                                ...
                                <td>
                                    <button class="btn btn-success" 
                                            onclick="window.open('print_stock_add.php?ref=<?php echo $row['ref']; ?>', '', 'width=800,height=400')">
                    ...
                    <div class="pull-right">
                        ...
                        <ul class="pagination">
                            ...
                            if($page_number != 1)
                            {
                                ?>
                            <li class="previous">
                                <a href="stock_update_report.php?page=<?php echo $page_number - 1; ?>">Prev</a>
                            </li>
                                <?php
                            }
                            ?>
                            ...
                            <li class="<?php  $i == $page_number ? print 'active' : ''; ?>">
                                <a href="stock_update_report.php?page=<?php echo $i; ?>" >
                                    <?php echo $i; ?>
                                </a>
                            </li>
                                <?php
                            ...
                            if($page_number != $page_count)
                            {
                                ?>
                            <li class="next">
                                <a href="stock_update_report.php?page=<?php echo $page_number + 1; ?>"> Next</a>
                            </li>
                                <?php
                            }
                            ?>
