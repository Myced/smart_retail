...
$query = "SELECT * from `return_clients`";
...
//do the query here
$query = "SELECT * FROM `return_clients` ORDER BY `id` DESC LIMIT $start, $end";
$result = mysqli_query($dbc, $query)
        or die("Error");
                        ...
                        <table class="table table-striped table-bordered text-center white-background table-condensed">
                          ...
                          if(isset($show_search))
                          {
                                if (!isset($error)) 
                                {
                                    ...
                                    //now do a query
                                    $query = "SELECT * FROM `return_clients` WHERE "
                                          ...
                                          <tr style="background-color:  white;">
                                            ...
                                            <td>
                                                <button class="btn btn-success" 
                                                        onclick="window.open('print_returned_products.php?ref=<?php echo $row['ref']; ?>', '', 'width=800,height=400')">
                                  ...
                                  <tr class="white-background">
                                      <td colspan="6" class="text-center">
                                        <strong class="text-primary">
                                            No Items Returned For this period
                                        </strong>
                                      </td>
                                    </tr>
                                    <?php
                    ...
                    <div class="pull-right">
                        ...
                        <ul class="pagination">
                            ...
                            if($page_number != 1)
                            {
                                ?>
                            <li class="previous">
                                <a href="returned_products.php?page=<?php echo $page_number - 1; ?>">Prev</a>
                            </li>
                                <?php
                            }
                            ?>
                            ...
                            <li class="<?php  $i == $page_number ? print 'active' : ''; ?>">
                                <a href="returned_products.php?page=<?php echo $i; ?>" >
                                    <?php echo $i; ?>
                                </a>
                            </li>
                                <?php
                            ...
                            if($page_number != $page_count)
                            {
                                ?>
                            <li class="next">
                                <a href="returned_products.php?page=<?php echo $page_number + 1; ?>"> Next</a>
                            </li>
                                <?php
                            }
                            ?>
